...
<div id="facturas_proveedor_lista">
	<div>
		<a href="<?php echo base_url();?>proveedor" class="btn btn-info">Proveedores</a>
	</div>
	<table class="table table-striped">
		<tr><th># Interno</th><th>Folio</th><th>Empresa</th><th>Total</th><th>PDF</th><th>XML</th><th>Fecha</th></tr>
